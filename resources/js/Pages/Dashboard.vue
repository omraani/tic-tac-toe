    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    class="bg-white overflow-hidden shadow-sm sm:rounded-lg py-4 px-4"
                >
                    <Link
                    ...
                    <ul class="divide-y mt-6">
                        ...
                        >
                            ...
                            <Link
                                ...
                                method="post"
                                as="button"
                                class="hover:bg-gray-50 transition-colors p-2 rounded"
                                >Join Game</Link
                            >
                        </li>
                    </ul>
...
// listen and filter selected game id is not equal event game id
